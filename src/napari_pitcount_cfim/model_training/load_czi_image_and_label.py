...
def load_and_preprocess(plot=True):
    ...
    image_path = file_path / "data" / "Images" / "1c450669-fe0f-43f7-8e58-e4c74f89cb74" / "Tube 70 4 fluor.czi"
    label_path = file_path / "data" / "Labels" / "1c450669-fe0f-43f7-8e58-e4c74f89cb74" / "Tube 70 4 fluor.czi"
    ...
    np.save(file_path / "data" / "label.npy", label)
    return True
