...
if __name__ == "__main__":
    ...
    image_path = dir_path / "training_data" / "Images" / "1c450669-fe0f-43f7-8e58-e4c74f89cb74" / "Tube 70 4 fluor.czi"
    ...
    np.save(dir_path / "training_data" / "deep_features.npy", vgg_features)